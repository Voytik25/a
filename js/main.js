...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/counter */ "./src/js/components/counter.js");
/* harmony import */ var _components_counter__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_counter__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_btn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/btn */ "./src/js/components/btn.js");
/* harmony import */ var _components_btn__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_btn__WEBPACK_IMPORTED_MODULE_2__);
...
// Кнопка фильтра товаров

document.addEventListener('DOMContentLoaded', () => {
  const menuBtns = document.querySelectorAll('.filter__btn');
  const drops = document.querySelectorAll('.filter__menu');
  menuBtns.forEach(el => {
    el.addEventListener('click', e => {
      let currentBtn = e.currentTarget;
      let drop = currentBtn.closest('.filter').querySelector('.filter__menu');
      menuBtns.forEach(el => {
        if (el !== currentBtn) {
      ...
      drops.forEach(el => {
        if (el !== drop) {
          el.classList.remove('filter__menu--active');
        }
      });
      drop.classList.toggle('filter__menu--active');
...
if (menu && menuBtn) {
  menuBtn.addEventListener('click', () => {
    ...
    menuBtn.classList.toggle('burger__btn--active');
    main.classList.toggle('main--active');
    footer.classList.toggle('footer--active');
  });
}
document.addEventListener('DOMContentLoaded', () => {
  const menuBtns = document.querySelectorAll('.profile__btn');
  const drops = document.querySelectorAll('.profile__menu');
  menuBtns.forEach(el => {
    el.addEventListener('click', e => {
      let currentBtn = e.currentTarget;
      let drop = currentBtn.closest('.profile').querySelector('.profile__menu');
      menuBtns.forEach(el => {
        if (el !== currentBtn) {
          el.classList.remove('profile__btn--active');
        }
      });
      drops.forEach(el => {
        if (el !== drop) {
          el.classList.remove('profile__menu--active');
        }
      });
      drop.classList.toggle('profile__menu--active');
      currentBtn.classList.toggle('profile__btn--active');
    });
  });
  document.addEventListener('click', e => {
...
search.addEventListener('click', function (e) {
  ...
  left.classList.add('header__left--none');
  right.classList.add('header__right--active');
...
closeSearch.addEventListener('click', function (e) {
  ...
  left.classList.remove('header__left--none');
  right.classList.remove('header__right--active');
...
const swiperHero = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
  slidesPerView: 1,
  pagination: {
...
const swiperProduce = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.produce__swiper', {
  slidesPerView: 1,
  spaceBetween: 10
});
const swiperCatalog = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.catalog__swiper', {
  slidesPerView: _popperjs_core__WEBPACK_IMPORTED_MODULE_1__.auto,
  spaceBetween: 12
});
const swiperCard = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.card__swiper', {
  spaceBetween: 12,
  pagination: {
    el: '.swiper-pagination',
    clickable: true
